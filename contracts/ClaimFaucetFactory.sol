...
contract ClaimFaucetFactory {
    ...
    function getUserDeployedContractByIndex(uint8 _index) external view returns (address deployer, address deployedContract_){
        ...
        deployer = _deployedContract.deployer;
